...
if (new Date - user.lastdiamantes < 900000) return await conn.reply(m.chat, `*⏱️ Vuelva en ${msToTime(time - new Date())} para continuar minando ${global.rpgshopp.emoticon('limit')}⛏️`, fkontak,  m)
...
let sity = `*${premium ? '🎟️ Recompensa Premium' : '🆓 Recompensa Gratis'}*\n*${minar}*\n*${limit} ${global.rpgshop.emoticon('limit')}*\n\n🍁 𝗕 𝗢 𝗡 𝗢\n\n${texto}\n\n🎟️ 𝗣 𝗥 𝗘 𝗠 𝗜 𝗨 𝗠 ⇢ ${premium ? '✅' : '❌'}\n${wm}`
await conn.sendFile(m.chat, pp, 'curiosity.jpg', sity, fkontak)
