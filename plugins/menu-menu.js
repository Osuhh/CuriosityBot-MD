...
*ႌ〬╔═════「 *U S U A R I O S* 」═════╗
*ႌ〬║⫹⫺ CREADOR:* ${azami}
*ႌ〬║⫹⫺ DUEÑO:* wa.me/59894808483
*ႌ〬║⫹⫺ BOT OFC:* ${animxscans}
*ႌ〬║⫹⫺ USUARIOS:* ${rtotalreg}
*ႌ〬║⫹⫺ PREFIX* ${usedPrefix}
*ႌ〬║⫹⫺ ACTIVIDAD:* ${uptime}
*ႌ〬║⫹⫺ REGISTRADOS :* ${rtotalreg}
*ႌ〬╚════ ≪ •❈• ≫ ════╝
...
*ႌ〬╔═════「 *I N F O R M A C I Ó N * 」═════╗
*ႌ〬║⫹⫺ ${usedPrefix}estado
*ႌ〬║⫹⫺ ${usedPrefix}owner
*ႌ〬║⫹⫺ ${usedPrefix}grouplist
*ႌ〬║⫹⫺ ${usedPrefix}donar
*ႌ〬║⫹⫺ ${usedPrefix}grupos
*ႌ〬║⫹⫺ ${usedPrefix}infobot
*ႌ〬║⫹⫺ ${usedPrefix}cuentas
*ႌ〬║⫹⫺ ${usedPrefix}reporte
*ႌ〬║⫹⫺ ${usedPrefix}join
*ႌ〬║⫹⫺ bot
*ႌ〬╚════ ≪ •❈• ≫ ════╝
